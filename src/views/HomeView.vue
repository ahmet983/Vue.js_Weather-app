...
const previewCity = (searchResult) => {
  console.log("PLACE NAME =>", searchResult.place_name.split(",")[0]);
  localStorage.place_name = searchResult.place_name.split(",")[0]
...
const mapboxAPIKey = "pk.eyJ1Ijoic2lyb3ppa2FzIiwiYSI6ImNsa2liMGQxYjAzamszbWxlbzBnb3ZsMW0ifQ.DLo8QYVLmDZtCQNZBcFFkA"
